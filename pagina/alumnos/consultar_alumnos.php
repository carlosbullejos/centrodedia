        ...
        <table border="1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="borrar_alumnos.php?id=<?= $registro[0] ?>"><img src="../img/borrar.png" alt="Borrar" width="20"></a></td>
                    <td><a href="actualizar_alumnos.php?id=<?= $registro[0] ?>"><img src="../img/actualizar.png" alt="Actualizar" width="20"></a></td>
                </tr>
                                </tr>
                <?php endwhile; ?>
            </tbody>
        ...
        <table>
            <tr>
                <td colspan="12" style="text-align: center;">
                    <a href="alumnos.php" class="add-button">Agregar Nuevo Alumno</a>
                </td>
            </tr>
        </table>
    </center>
